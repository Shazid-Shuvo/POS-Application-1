...
<script>
    ...
    async function FillUpUpdateForm(id,filePath){
        ...
        document.getElementById('productCategoryUpdate').value=res.data['category'];
    ...
    async function update() {
        ...
        if (productCategoryUpdate.length === 0) {
        ...
        else if(productQuantityUpdate.length===0){
            ...
            formData.append('category',productCategoryUpdate)
